...
pygame.display.set_caption("set collision")
all_sprites = pygame.sprite.Group()

sprite1 = Sprite(pygame.Color('black'), 20, 30)
sprite1.rect.x, sprite1.rect.y = random.randint(
    0, SCREEN_HEIGHT-sprite1.rect.height), random.randint(0, SCREEN_WIDTH-sprite1.rect.width)

all_sprites.add(sprite1)

sprite2 = Sprite(pygame.Color('black'), 20, 30)
sprite2.rect.x, sprite2.rect.y = random.randint(
    0, SCREEN_HEIGHT-sprite2.rect.height), random.randint(0, SCREEN_WIDTH-sprite2.rect.width)
